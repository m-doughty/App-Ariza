...
$env:RAKULIB = 'inst#' + (Join-Path $BundleRoot 'site')
...
$ArizaStateDir = Join-Path ($env:LOCALAPPDATA ? $env:LOCALAPPDATA : $env:TEMP) 'moneymoor'
...
& $ArizaRaku (Join-Path $BundleRoot 'site\bin\moneymoor.raku') @args
exit $LASTEXITCODE
