@echo off
rem Moneymoor 0.2.0 -- self-contained bundle launcher.
rem
...
if not exist "%ARIZA_RAKU%" (
    echo Moneymoor: this bundle is incomplete - no interpreter at "%ARIZA_RAKU%" 1>&2
...
set "ARIZA_STATE_DIR=%LOCALAPPDATA%\moneymoor"
if not exist "%ARIZA_STATE_DIR%\.first-run" (
    echo Moneymoor: first launch can take a few seconds. Later ones are instant. 1>&2
...
"%ARIZA_RAKU%" "%BUNDLE_ROOT%\site\bin\moneymoor.raku" %*
exit /b %ERRORLEVEL%
