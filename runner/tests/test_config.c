...
static void test_golden_sidecar(void)
{
	...
	T_EQ(cfg.target, "site\\bin\\moneymoor.raku");
	T_EQ(cfg.app_display, "Moneymoor");
	T_EQ(cfg.app_exec, "moneymoor");
...
static const char *RENDERED =
	"# Moneymoor 0.2.0 -- ariza runner configuration.\r\n"
	"#\r\n"
	"# Read by bin\\moneymoor.exe. Generated by ariza; edit the bundle,\r\n"
	"# not this file.\r\n"
	"\r\n"
